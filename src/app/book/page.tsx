...
export default function BookPage() {
  ...
  return (
    <>
      {/* Page Hero */}
      <section className="relative h-[30vh] flex items-center justify-center bg-gradient-to-r from-bronze to-gold mt-20">
      ...
      <section className="py-24 lg:py-28 bg-cream">
        <div className="container mx-auto px-6 lg:px-8 max-w-5xl">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
            <div className="min-h-[600px] flex items-center justify-center bg-sand rounded-lg">
          ...
          <div className="mt-12 bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-bronze rounded-full flex items-center justify-center mx-auto mb-3">
